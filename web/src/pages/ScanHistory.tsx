        ...
        >
            ...
            <div className="bg-white rounded-lg shadow border border-neutral-200">
                <div className="p-6 border-b border-neutral-200">
                    <h2 className="text-xl font-semibold text-neutral-800">Recent Scans</h2>
                </div>
                ...
                <div className="p-6">
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={scan.id} className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
                                <div>
                                    <h3 className="font-semibold text-neutral-800">{scan.product}</h3>
                                    <p className="text-sm text-neutral-600">Scanned by {scan.user} • {scan.time}</p>
                                </div>
