                ...
                <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between py-3 border-b border-gray-100">
                            <div>
                                <h3 className="font-medium text-gray-800">Blockchain Difficulty</h3>
                                <p className="text-sm text-gray-600">Current mining difficulty level</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between py-3 border-b border-gray-100">
                            <div>
                                <h3 className="font-medium text-gray-800">Auto-verification</h3>
                                <p className="text-sm text-gray-600">Automatically verify scanned products</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between py-3">
                            <div>
                                <h3 className="font-medium text-gray-800">API Rate Limiting</h3>
                                <p className="text-sm text-gray-600">Requests per minute limit</p>
                            </div>
                            <input type="number" className="border border-gray-300 rounded-lg px-3 py-2 w-20" defaultValue="100" />
                        </div>
                    </div>
                </div>
