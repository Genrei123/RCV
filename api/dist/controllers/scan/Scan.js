...
exports.getScansByID = exports.getScans = exports.searchScannedProduct = exports.scanProduct = exports.initializeProductBlockchain = exports.globalProductBlockchain = exports.scanQR = void 0;
...
const aiProcess_1 = require("../../services/aiProcess");
...
const scanProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!OCRText || !OCRText.blockOfText) {
            return next(new CustomError_1.default(400, "OCR text is required", {
        ...
        const processedOCRText = yield (0, aiProcess_1.ProcessText)(OCRText.blockOfText);
...
const searchScannedProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!productName && !LTONumber && !CFPRNumber) {
            return next(new CustomError_1.default(400, "At least one search criteria is required", {
        ...
        if (productName) {
            searchCriteria.productName = (0, typeorm_1.ILike)(`%${productName}%`);
        }
        if (LTONumber) {
        ...
        if (!products || products.length === 0) {
            ...
            let sampleCompany = yield data_source_1.CompanyRepo.findOne({
                where: { name: "Sample Test Company" },
            });
            if (!sampleCompany) {
                console.log("Creating sample company...");
                sampleCompany = new company_entity_1.Company();
                ...
                sampleCompany = yield data_source_1.CompanyRepo.save(sampleCompany);
            ...
            const savedProduct = yield data_source_1.ProductRepo.save(newProduct);
...
exports.searchScannedProduct = searchScannedProduct;
const getScans = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { page, limit, skip } = (0, pagination_1.parsePageParams)(req, 10);
        const [scans, total] = yield data_source_1.ScanRepo.findAndCount({
            skip,
            take: limit,
