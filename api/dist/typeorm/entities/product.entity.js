...
exports.ProductValidation = zod_1.z.object({
    _id: zod_1.z.string().uuid().optional(),
    ...
    productClassification: zod_1.z.string().min(1).max(100),
    productSubClassification: zod_1.z.string().min(1).max(100),
    expirationDate: zod_1.z.preprocess(coerceDate, zod_1.z.date()),
    dateOfRegistration: zod_1.z.preprocess(coerceDate, zod_1.z.date()),
    registeredById: zod_1.z.string().uuid(),
    registeredAt: zod_1.z.preprocess(v => (v === undefined ? new Date() : coerceDate(v)), zod_1.z.date()).optional(),
    ...
    isActive: zod_1.z.preprocess(v => (v === undefined ? true : v), zod_1.z.boolean()).optional()
});
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Product.prototype, "registeredById", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Date)
], Product.prototype, "registeredAt", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => company_entity_1.Company, company => company._id),
