...
const CompanyController = __importStar(require("../../controllers/company/Company"));
...
CompanyRouter.post('/companies', verifyUser_1.verifyUser, CompanyController.createCompany);
