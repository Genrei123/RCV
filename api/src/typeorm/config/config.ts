...
const config: DataSourceOptions = {
  ...
  entities: [User, Product, Company, ScanHistory, ForgotPassword, AuditLog, ComplianceReport, AdminInvite, BrandName, ProductClassification, CertificateApproval], // Add yung models na ginagawa
