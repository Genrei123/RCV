...
enum SackSide { front, back }

class SackCapturePage extends StatefulWidget {
  final VoidCallback onComplete;
  final Function(Map<SackSide, String?>) onImagesSelected;

  const SackCapturePage({
    super.key,
  ...
  @override
  State<SackCapturePage> createState() => _SackCapturePageState();
}

class _SackCapturePageState extends State<SackCapturePage> {
  final ImagePicker _imagePicker = ImagePicker();
  Map<SackSide, String?> capturedImages = {
    SackSide.front: null,
    SackSide.back: null,
  };

  Future<void> _captureImage(SackSide side) async {
    try {
  ...
  String _getCaptureSideLabel(SackSide side) {
    switch (side) {
      case SackSide.front:
  ...
  Widget _buildSackImageSlot(SackSide side) {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Capture both front and back images of the sack for product scanning.',
                ...
                Row(
                  children: [
                    Expanded(
                      child: SizedBox(
                        height: 280,
                        child: _buildSackImageSlot(SackSide.front),
                      ),
                    ),
                    ...
                    Expanded(
                      child: SizedBox(
                        height: 280,
                        child: _buildSackImageSlot(SackSide.back),
                      ),
                    ),
                  ],
                ),
