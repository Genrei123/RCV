...
class HomeArchivePage extends StatefulWidget {
  const HomeArchivePage({Key? key}) : super(key: key);

  @override
  State<HomeArchivePage> createState() => _HomeArchivePageState();
}

class _HomeArchivePageState extends State<HomeArchivePage> {
  ...
  void _showActionsModal(BuildContext context, Map<String, dynamic> user, Offset position) {
    try {
      ...
      showMenu(
        ...
        if (value == 'archive') {
          _showArchiveConfirmationDialog(context, user);
        }
      });
    } catch (e) {
  ...
  void _showArchiveConfirmationDialog(BuildContext context, Map<String, dynamic> user) {
    showDialog(
      context: context,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        // Add archive functionality here if needed
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: app_colors.AppColors.darkAccent,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
                        padding: const EdgeInsets.symmetric(vertical: 8),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: GradientHeaderAppBar(
        greeting: '',
        user: 'User Accounts',
        onBack: () => Navigator.pushReplacementNamed(context, '/admin-home'),
        showBackButton: true,
      ),
      body: isLoading 
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    // Search, Filter, Archive, and Pending buttons
                    Row(
                      children: [
                        // Search Bar
                        Expanded(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text('Archive', style: TextStyle(color: Colors.white, fontSize: 10)),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: app_colors.AppColors.darkAccent,
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
