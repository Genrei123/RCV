...
class AppColors {
  ...
  static const Color darkPrimary = Color(
    0xFF00A76F,
  ); // Headers, buttons, highlights (brighter green)
  static const Color darkAccent = Color(
    0xFFFFC107,
  ); // Secondary buttons, footers, hover states (golden yellow)
  static const Color darkSecondary = Color(
    0xFF81C784,
  ); // Accent elements, icons, CTAs (muted green)
  static const Color darkNeutral = Color(
    0xFF1E1E1E,
  ); // Secondary backgrounds, dividers (surface)
  static const Color darkText = Color(
    0xFFE0E0E0,
  ); // Primary text, icons (light gray)
  static const Color darkWhite = Color(
    0xFF121212,
  ); // Backgrounds, cards, clean areas (dark background)
  static const Color darkMuted = Color(
    0xFFB7B7B7,
  ); // for placeholders (same as light)

  // Optional semantic colors (Dark Mode)
  static const Color darkError = Color(
    0xFFCF6679,
  ); // Softer red for dark background
